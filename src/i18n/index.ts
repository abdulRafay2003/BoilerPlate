...
export const resources = {
    en: {
        translation: {
            ...
            Onboarding_text1: "Take your investment knowledge to the next level with Nmo academy's expert-led courses.",

            // OnboardingSCREEN2
            Onboarding_heading2: "Ask, Help, Earn: Our Interact & Reward Points Program",
            Onboarding_text2: "Interact and earn rewards with our points program! Help classmates and earn points redeemable for cash or future course purchases. Start building your rewards now.",
            skip: "Skip",
            next: "Next",
            ...
            otp_text: "6 digit code sent to your mobile. Please check and confirm the code to continue",
            ...
            terms_and_conditions: "By confirming, this will create your account. Review our terms and conditions",
            ...
            privacy_policy_desc: "In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design",
            terms_conditions_desc: "In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design In this course we will study the initial stages of becoming a UI/UX Designer, I have several steps that I often do when I want to make a Website Design or App Design",

            // Points_Program
            points_program_desc: "It is a program that gives the student several points when registering for any course, the value of each point is 5 Saudi riyals. The student can exchange these points by purchasing another course within the academy, or exchange them for a sum of money after exceeding 5000 riyals or 1000 points.",
            question_one: "How do you get points?",
            ans_one: "When you buy a course, you will get a set of points, which you can use as you like. Or when you help another student participating in the same course through interactive classes, the other student can give you one point equal to 5 riyals, and several students can give you these points.",
            question_two: "How do I get points from another student?",
            ans_two: "Through interactive classes, you can offer a point to another student when he helps you explain a specific piece of information, and this point will be deducted from your balance. Each course is linked to an interactive class in which students participate.",
            points_balance: "Points balance",
            points_balance_desc: "Each student has a balance of points, when he participates in any course that gives several points, and the student can increase his points by helping others, also other students can deduct points from him.",
            question_three: "How do I exchange points for money?",
            ans_three: "After your points balance exceeds 1,000 points or 5,000 riyals, you can contact technical support to transfer this amount to your bank account.",
            ...
            common_ans_one: "Courses in the Saudi, American and global stock markets, investment funds and indices, REIT funds - crowdfunding with debt and equity, sukuk, options, digital currencie",

            // INVITESCREEN
            invite_your_friends: "Invite your friends",
            invite_desc: "Refer your friends & earn up to 25% successfully message congration dummy text very benefits on your activity",
            invite_rewards: "Your invitation gets rewards",
            invite_rewards_desc: "Refer your friends & earn up to 25% successfully message congration dummy text very benefits on your activity",
            ...
            withdraw_desc: "Payment processing fees are charged by electronic payment gateways such as PayPal and credit cards.",
        ...
        ar: {
            translation: {
                ...
                about_us_desc: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                privacy_policy_desc: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                terms_conditions_desc: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",

                // Points_Program
                points_program_desc: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                question_one: "اللغةاختار اللغة?",
                ans_one: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                question_two: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة?",
                ans_two: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                points_balance: "اللغةاختار اللغةاللغةاختار اللغةاللغة",
                points_balance_desc: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                question_three: "اللغةاختار اللغةاللغةاختار اللغة?",
                ans_three: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                question_four: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة?",
                ans_four: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                ...
                invite_desc: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
                invite_rewards: "اللغةاختار اللغة",
                invite_rewards_desc: "اللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغةاللغةاختار اللغة",
