  ...
  return (
    <Animated.View
      style={{
        ...
        marginHorizontal: 10,
        backgroundColor: selected ? Utills.selectedThemeColors().Primary : Utills.selectedThemeColors().DotGrey,
  ...
  return (
    <FadeContainer
      ...
      <TouchableOpacity onPress={handleOnSkipAndDone}>
        <CustomText.RegularText isSecondaryColor>{t('skip')}</CustomText.RegularText>
      </TouchableOpacity>
    </FadeContainer>
  );
};
